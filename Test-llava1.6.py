...
output_csv = f"InternVL2-results_{timestamp}.csv"

generation_config = dict(max_new_tokens=1024, do_sample=False)

# Open the CSV file for writing
with open(output_csv, mode='w', newline='') as csv_file:
    fieldnames = ['Model','Image_filename', 'Extracted-text', 'Inference-time']
        ...
        if os.path.exists(input_path):
            ...
            try:
                with Image.open(input_path) as img:
                    ...
                    # convert to RGB
                    question = '<image>\nExtract information from this form image, provide output in json format.'
                    ...
                    writer.writerow({'Model': 'InterVL2', 'Image_filename': file_name, 'Extracted-text': json_str, 'Inference-time': inference_time})
